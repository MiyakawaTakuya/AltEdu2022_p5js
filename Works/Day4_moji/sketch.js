...
function preload() {
  // joinedText = loadStrings('faust_kurz.txt');
  // joinedText = "I want to be a person of many personalities. Just like the weather.";
  joinedText = "|曇天dontenどんてん|雨曇りamagumoriあまぐもり|時化空shikezoraしけぞら|花曇りhanagumoriはなぐもり|通り雨toriameとおりあめ";
}

function setup() {
  createCanvas(1220, windowHeight / 2);
